...
(function(c) {
    ...
    c.extend(c.validator, {defaults:{messages:{},groups:{},rules:{},errorClass:"error",
        ...
        c.extend(c.validator.defaults,
            a)
    },messages:{required:"This field is required.",remote:"Please fix this field.",email:"请输入正确的邮箱.",url:"请输入正确的地址.",date:"请输入正确的日期.",dateISO:"Please enter a valid date (ISO).",number:"请输入正确的数字.",digits:"请输入正确的数字.",creditcard:"Please enter a valid credit card number.",equalTo:"请输入相同的字符.",accept:"Please enter a value with a valid extension.",maxlength:c.validator.format("请不要超过{0}个字符."),
        minlength:c.validator.format("至少输入{0}个字符."),rangelength:c.validator.format("输入长度需要在 {0} 到 {1} 之间."),range:c.validator.format("输入值需要在 {0} 到 {1} 之间."),max:c.validator.format("输入值需要小于等于{0}."),min:c.validator.format("输入值需要大于等于{0}.")},autoCreateRanges:false,prototype:{init:function() {
        function a(e) {
        ...
        //修正返回false时仍然通过验证的缺陷；add by chengfeng 20111229
