...
<form id="myform" method="post" >
    <table align="center" >
        ...
        <tr>
            <td>请输入用户名：</td>
            <td><input type="text" name="user.name" id="name" value="${user.name}"></td>
        </tr>
        <tr>
            <td>请输入密码：</td>
            <td><input type="password" name="user.password" id="password" value="${user.password}"></td>
        </tr>
        <tr>
            <td>请选择角色：</td>
            <td>
